...
> 💡 **Совет**: если вы просто хотите зашифровать что-то «здесь и сейчас» — используйте [онлайн-версию](#-онлайн-github-pages) ниже.
...
```
• Минимум 16 символов (чем длиннее, тем лучше)
• Комбинируйте: Aa + 123 + !@# (минимум по 2 каждого типа)
• Используйте фразу-пароль и преобразуйте её:
  "Кот_Васька_Любит_3_Рыбы" → "Kot#Vaska_Lubit3Riby!%"
• Добавляйте необычные символы: π, Ω, €, 😊
• Следите за индикатором — дождитесь 4 полосок ("Отличный")
```

###❌ Не делайте так:

```
• Даты рождения, имена, клички, годы (1990–2030)
• "123456", "password", "qwerty", "admin", "secret"
• Клавиатурные последовательности: "qwerty", "йцукен", "123456"
• Словарные слова из 1200+ запрещённых
...
```
[██░░░░░░░░] — Слабый (менее 12 символов или однотипный)
[████░░░░░░] — Средний (12+ символов, но мало разнообразия)
[████████░░] — Хороший (16+ символов, есть разные типы)
[████████████] — Отличный 🔒 (все требования выполнены!)
```

###🔥 Примеры паролей уровня «Отличный»:
...
<p align="center">
  ...
  <em>AES-256-GCM · Argon2id · 128 MB · Parallel 8</em><br><br>
